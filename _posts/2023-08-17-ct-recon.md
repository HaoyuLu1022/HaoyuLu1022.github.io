...
for $\theta$. Given that it's not computationally tractable, **variational approximation** methods are adopted to approximate the posterior by a set of approximation distributions
