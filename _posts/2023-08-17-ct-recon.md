...
- [Approach](#approach)
  ...
  - [In This Paper](#in-this-paper)
    - [Brief Introduction to Variantional Approximation](#brief-introduction-to-variantional-approximation)
- [Method](#method)
  - [Training](#training)
  - [Testing](#testing)
...
### Brief Introduction to Variantional Approximation
...
$$
p(\boldsymbol{\theta}|\boldsymbol{\mu}), \boldsymbol{\theta}=\boldsymbol{\mu}\odot \boldsymbol{b},
$$
